...
function DashboardCtrl(e,t,n,o,i,s,a,c,l){function r(){console.log("socket init!"),i.on("connect",function(){console.log("socket connect")}),i.on("server-to-client",function(t){var n=t.topic;n=n.split("/"),n=n[2];var o=s.findIndex(e.standardItems,function(e){return e.thingId===n});e.standardItems[o].inputValue=t.payload})}function d(t){a.getWidgets(f).then(function(n){e.standardItems=n,t&&s.forEach(n,function(e,t){i.emit("subscribe",{topic:"sub/"+f+"/"+e.thingId})})},function(e){}),r()}function u(t){var n={sizeX:1,sizeY:1};t.owner=f,t.widgetInfo=n,a.createWidget(f,t).then(function(t){e.alertMessage={message:"Successfully Added a Widget",type:"success"},d()},function(e){})}function g(e){if(e["delete"])console.log("delete!"),console.log(e),a.deleteWidgetById(f,e.id,e).then(function(e){d()},function(e){console.log("error")});else{console.log(e);var t=e.id;delete e.id,a.updateWidgetById(f,t,e).then(function(e){d()},function(e){})}}console.log("dashboard!");var f="";c.currentUser&&(f=c.currentUser.info.id),e.size=120,e.progress=.5,e.strokeWidth=20,e.stroke="#1abc9c",e.background="lightgrey",e.counterClockwise="",e.roundProgressData={label:80,percentage:.11},e.$on("$locationChangeStart",function(e,t){console.log("next"),i.disconnect()}),e.alertShow=!1,e.closeAlert=function(){e.alertShow=!1},d(!0),e.gridsterOpts={floating:!1,resizable:{enabled:!0,handles:["n","e","s","w","ne","se","sw","nw"],start:function(e,t,n){},resize:function(e,t,n){},stop:function(t,n,o){console.log(o),e.saveWidgets()}},draggable:{enabled:!0,handle:".my-class",start:function(e,t,n){},drag:function(e,t,n){},stop:function(t,n,o){console.log(o),e.saveWidgets()}}},e.customItemMap={sizeX:"item.widgetInfo.sizeX",sizeY:"item.widgetInfo.sizeY",row:"item.widgetInfo.row",col:"item.widgetInfo.col",minSizeY:"item.minSizeY",maxSizeY:"item.maxSizeY"},e.standardItems2=[{attributes:{name:"box1",widgetInfo:{sizeX:6,sizeY:1,row:0,col:0}}},{attributes:{name:"box2",widgetInfo:{sizeX:2,sizeY:2,row:0,col:2}}}],e.executeButton=function(e){console.log(e),i.emit("publish",{topic:"pub/"+f+"/"+e.thingId,payload:e.payload})},e.saveWidgets=function(){angular.forEach(e.standardItems,function(e,t){console.log("save widgets");var n={widgetInfo:e.widgetInfo};a.updateWidgetById(f,e._id,n).then(function(e){},function(e){})}),e.alertShow=!0,e.alertMessage={message:"Successfully Saved!",type:"success"},l(function(){e.alertShow=!1},2e3)},e.addThing=function(e){var t=n.open({animation:!1,templateUrl:"templates/widgetModal.html",controller:"WidgetModalCtrl",resolve:{items:function(){return!1}}});t.result.then(function(e){u(e)},function(){})},e.openSettings=function(e){console.log(e);var t=n.open({animation:!1,templateUrl:"templates/widgetModal.html",controller:"WidgetModalCtrl",resolve:{items:function(){return e}}});t.result.then(function(e){g(e)},function(){})}}angular.module("RDash").controller("DashboardCtrl",["$scope","$cookieStore","$uibModal","thingService","socket","lodash","widgetService","$localStorage","$timeout",DashboardCtrl]);
