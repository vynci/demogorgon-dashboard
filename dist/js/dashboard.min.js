...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/dashboard.html",controller:"DashboardCtrl"}).state("tables",{url:"/tables",templateUrl:"templates/tables.html"}).state("login",{url:"/login",templateUrl:"templates/login.html"})}]);
...
function MasterCtrl(t,o){var g=992;t.getWidth=function(){return window.innerWidth},t.$watch(t.getWidth,function(e,n){e>=g?angular.isDefined(o.get("toggle"))?t.toggle=!!o.get("toggle"):t.toggle=!0:t.toggle=!1}),t.isLoggedIn=!1,t.doLogin=function(){t.isLoggedIn=!0},t.doLogout=function(){t.isLoggedIn=!1},t.toggleSidebar=function(){t.toggle=!t.toggle,o.put("toggle",t.toggle)},window.onresize=function(){t.$apply()}}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore",MasterCtrl]);
