...
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider","$httpProvider",function(t,e,r){e.otherwise("/dashboard"),t.state("index",{url:"/dashboard",templateUrl:"templates/dashboard.html",controller:"DashboardCtrl"}).state("things",{url:"/things",templateUrl:"templates/things.html",controller:"ThingCtrl"}).state("settings",{url:"/settings",templateUrl:"templates/settings.html",controller:"SettingCtrl"}).state("login",{url:"/login",templateUrl:"templates/login.html"})}]).run(["$rootScope","$http","$location","$localStorage",function(t,e,r,l){console.log("run"),l.currentUser&&(e.defaults.headers.common["x-access-token"]=l.currentUser.token),t.$on("$locationChangeStart",function(t,e,o){var n=["/login"],a=-1===n.indexOf(r.path());a&&!l.currentUser&&r.path("/login")})}]);
...
function DashboardCtrl(e,t,n,o,i,s,a,r,c){function l(t){a.getWidgets(g).then(function(n){e.standardItems=n,t&&s.forEach(n,function(e,t){i.emit("subscribe",{topic:"sub/"+g+"/"+e.thingId})})},function(e){})}function d(t){var n={sizeX:1,sizeY:1};t.owner=g,t.widgetInfo=n,a.createWidget(g,t).then(function(t){e.alertMessage={message:"Successfully Added a Widget",type:"success"},l()},function(e){})}function u(e){if(e["delete"])console.log("delete!"),console.log(e),a.deleteWidgetById(g,e.id,e).then(function(e){l()},function(e){console.log("error")});else{console.log(e);var t=e.id;delete e.id,a.updateWidgetById(g,t,e).then(function(e){l()},function(e){})}}var g="";r.currentUser&&(g=r.currentUser.info.id),e.size=120,e.progress=.5,e.strokeWidth=20,e.stroke="#1abc9c",e.background="lightgrey",e.counterClockwise="",e.roundProgressData={label:80,percentage:.11},e.$watch("roundProgressData",function(e,t){e.percentage=e.label/100},!0),i.on("connect",function(){console.log("socket connect"),l(!0)}),i.on("server-to-client",function(t){var n=t.topic;n=n.split("/"),n=n[2];var o=s.findIndex(e.standardItems,function(e){return e.thingId===n});e.standardItems[o].inputValue=t.payload}),e.alertShow=!1,e.closeAlert=function(){e.alertShow=!1},l(!0),e.gridsterOpts={floating:!1,resizable:{enabled:!0,handles:["n","e","s","w","ne","se","sw","nw"],start:function(e,t,n){},resize:function(e,t,n){},stop:function(t,n,o){console.log(o),e.saveWidgets()}},draggable:{enabled:!0,handle:".my-class",start:function(e,t,n){},drag:function(e,t,n){},stop:function(t,n,o){console.log(o),e.saveWidgets()}}},e.customItemMap={sizeX:"item.widgetInfo.sizeX",sizeY:"item.widgetInfo.sizeY",row:"item.widgetInfo.row",col:"item.widgetInfo.col",minSizeY:"item.minSizeY",maxSizeY:"item.maxSizeY"},e.standardItems2=[{attributes:{name:"box1",widgetInfo:{sizeX:6,sizeY:1,row:0,col:0}}},{attributes:{name:"box2",widgetInfo:{sizeX:2,sizeY:2,row:0,col:2}}}],e.executeButton=function(e){console.log(e),i.emit("publish",{topic:"pub/"+g+"/"+e._id,payload:e.payload})},e.saveWidgets=function(){angular.forEach(e.standardItems,function(e,t){console.log(e);var n={widgetInfo:e.widgetInfo};a.updateWidgetById(g,e._id,n).then(function(e){},function(e){})}),e.alertShow=!0,e.alertMessage={message:"Successfully Saved!",type:"success"},c(function(){e.alertShow=!1},2e3)},e.addThing=function(e){var t=n.open({animation:!1,templateUrl:"templates/widgetModal.html",controller:"WidgetModalCtrl",resolve:{items:function(){return!1}}});t.result.then(function(e){d(e)},function(){})},e.openSettings=function(e){console.log(e);var t=n.open({animation:!1,templateUrl:"templates/widgetModal.html",controller:"WidgetModalCtrl",resolve:{items:function(){return e}}});t.result.then(function(e){u(e)},function(){})}}angular.module("RDash").controller("DashboardCtrl",["$scope","$cookieStore","$uibModal","thingService","socket","lodash","widgetService","$localStorage","$timeout",DashboardCtrl]);
function MasterCtrl(e,o,n,i,s,r,t){var a=992;e.user={name:"",email:"",password:""},e.isLoggedIn=!1,i.currentUser?(e.isLoggedIn=!0,e.username=i.currentUser.info.name,e.userId=i.currentUser.info.id,e.email=i.currentUser.info.email):e.username="pipeero",e.getWidth=function(){return window.innerWidth},e.$watch(e.getWidth,function(n,i){n>=a?angular.isDefined(o.get("toggle"))?e.toggle=!!o.get("toggle"):e.toggle=!0:e.toggle=!1}),e.showRegisterForm=function(){e.isRegisterForm=!0},e.hideRegisterForm=function(){e.isRegisterForm=!1},e.doLogin=function(){e.isLoginLoading=!0,n.login(e.user).then(function(o){e.isLoginLoading=!1,o.success?(i.currentUser={info:o.data,token:o.token},s.defaults.headers.common["x-access-token"]=o.token,e.username=i.currentUser.info.name,e.userId=i.currentUser.info.id,e.email=i.currentUser.info.email,r.path("/dashboard"),e.isLoggedIn=!0):(e.invalidLoginToaster=!0,e.loginAlertMessage={message:o.message})},function(e){console.log(e)})},e.doRegister=function(){e.isRegisterLoading=!0,n.signup(e.user).then(function(o){if(e.isRegisterLoading=!1,o.errors){e.invalidLoginToaster=!0;var t="";t=o.errors.password?"Invalid Password":"Email address already taken, or might be invalid.",e.loginAlertMessage={message:t}}else{var a={email:o.email,password:o.password};n.login(a).then(function(o){e.isRegisterLoading=!1,o.success?(i.currentUser={info:o.data,token:o.token},s.defaults.headers.common["x-access-token"]=o.token,e.username=i.currentUser.info.name,e.userId=i.currentUser.info.id,e.email=i.currentUser.info.email,r.path("/dashboard"),e.isLoggedIn=!0,e.isLoginLoading=!1):(e.invalidLoginToaster=!0,e.loginAlertMessage={message:o.message},e.isLoginLoading=!1)},function(e){console.log(e)})}},function(o){console.log(o),e.isRegisterLoading=!1})},e.doLogout=function(){console.log("logout"),delete i.currentUser,console.log(i),s.defaults.headers.common["x-access-token"]="",e.isLoggedIn=!1,r.path("/login"),e.username="pipeero",t.location.reload()},e.closeLoginAlert=function(){e.invalidLoginToaster=!1},e.toggleSidebar=function(){e.toggle=!e.toggle,o.put("toggle",e.toggle)},window.onresize=function(){e.$apply()}}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore","authenticationService","$localStorage","$http","$location","$window",MasterCtrl]);
function SettingCtrl(r,e,n){console.log("settings!"),r.form={},n.currentUser&&(r.form.name=n.currentUser.info.name,r.form.userId=n.currentUser.info.id,r.form.email=n.currentUser.info.email)}angular.module("RDash").controller("SettingCtrl",["$scope","thingService","$localStorage",SettingCtrl]);
function ThingCtrl(n,t,e,o,i,l,r,c){var a="";r.currentUser&&(a=r.currentUser.info.id),e.getThingByUserId(a).then(function(t){console.log(t),n.things=t},function(n){}),n.editThing=function(n){var e=t.open({animation:!1,templateUrl:"templates/thingModal.html",controller:"ThingModalCtrl",resolve:{items:function(){return n}}});e.result.then(function(n){},function(){})},n.deleteThing=function(n){console.log(n)},n.addThing=function(){var n=t.open({animation:!1,templateUrl:"templates/thingModal.html",controller:"ThingModalCtrl",resolve:{items:function(){return!1}}});n.result.then(function(n){},function(){})}}angular.module("RDash").controller("ThingCtrl",["$scope","$uibModal","thingService","socket","lodash","widgetService","$localStorage","$timeout",ThingCtrl]);
function ThingModalCtrl(o,l,n,i,a){console.log(n),n?o.form={id:n._id,name:n.name}:o.form={},o.dismiss=function(){l.dismiss("cancel")}}angular.module("RDash").controller("ThingModalCtrl",["$scope","$uibModalInstance","items","thingService","$localStorage",ThingModalCtrl]);
function WidgetModalCtrl(e,t,n,o,a){var i=a.currentUser.info.id;"object"!=typeof n&&(e.showDeleteButton=!0,console.log("hey")),e.data={availableOptions:[{id:"1",name:"Input"},{id:"2",name:"Output"},{id:"3",name:"Graph"}],selectedOption:{id:"2",name:"Output"}},n?e.form={id:n._id,name:n.name,description:n.description,thingId:n.thingId,buttonLabel:n.buttonLabel,payload:n.payload,thingType:n.thingType}:e.form={},angular.forEach(e.data.availableOptions,function(t){t.name===n.thingType&&(e.data.selectedOption=t)}),e.generateThing=function(){var t={name:"default",owner:i,value:"default"};o.createThing(t).then(function(t){console.log(t),e.form.thingId=t._id},function(e){console.log("error")})},e.remove=function(){t.close(e.form),e.form["delete"]=!0},e.save=function(){console.log(e.data.selectedOption.name),e.form.thingType=e.data.selectedOption.name,t.close(e.form),e.form["delete"]=!1},e.dismiss=function(){t.dismiss("cancel")}}angular.module("RDash").controller("WidgetModalCtrl",["$scope","$uibModalInstance","items","thingService","$localStorage",WidgetModalCtrl]);
...
angular.module("RDash").service("thingService",["$q","$http","$window",function(e,r){function t(t){var n=e.defer();return r.get(i+"/pipe/"+t+"/thing/").success(function(e){n.resolve(e)}).error(function(){n.reject("Failed to get the ")}),n.promise}function n(t){var n=e.defer();return r.post(i+"/pipe/thing/",t).success(function(e){n.resolve(e)}).error(function(){n.reject("Failed to get the ")}),n.promise}var i="https://pipeero-rest-api.herokuapp.com";return{getThingByUserId:t,createThing:n}}]);
