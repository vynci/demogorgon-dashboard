Parse.initialize("pipeeroAppId","pipeeroJavascriptKey"),Parse.serverURL="http://localhost:1337/parse",angular.module("RDash",["ui.bootstrap","ui.router","ngCookies","gridster","ui.bootstrap.modal","btford.socket-io","ngLodash","angular-progress-arc","angular.directives-round-progress"]);
"use strict";angular.module("RDash").config(["$stateProvider","$urlRouterProvider",function(t,e){e.otherwise("/"),t.state("index",{url:"/",templateUrl:"templates/dashboard.html",controller:"DashboardCtrl"}).state("tables",{url:"/tables",templateUrl:"templates/tables.html"})}]);
...
function DashboardCtrl(e,t,n,o,i,s,a){function l(t){a.getWidgets(u).then(function(n){e.standardItems=n,t&&s.forEach(n,function(e,t){console.log(e.id),i.emit("subscribe",{topic:"sub/"+u+"/"+e.thingId})})},function(e){console.log(e)})}function c(t){var n={sizeX:1,sizeY:1};t.owner=u,t.widgetInfo=n,a.createWidget(u,t).then(function(t){e.alertMessage={message:"Successfully Added a Widget",type:"success"},l()},function(e){})}function r(e){if(e["delete"])console.log("delete!"),console.log(e),a.deleteWidgetById(u,e.id,e).then(function(e){l()},function(e){console.log("error")});else{console.log(e);var t=e.id;delete e.id,a.updateWidgetById(u,t,e).then(function(e){l()},function(e){})}}var d="laser42",u="57d6d72d7ee52c0300f3e8c6";e.size=120,e.progress=.5,e.strokeWidth=20,e.stroke="#1abc9c",e.background="lightgrey",e.counterClockwise="",e.roundProgressData={label:80,percentage:.11},e.$watch("roundProgressData",function(e,t){e.percentage=e.label/100},!0),i.on("connect",function(){console.log("socket connect"),l(!0)}),i.on("server-to-client",function(t){var n=t.topic;n=n.split("/"),n=n[2];var o=s.findIndex(e.standardItems,function(e){return e.thingId===n});e.standardItems[o].inputValue=t.payload}),e.alertShow=!1,e.closeAlert=function(){e.alertShow=!1},l(!0),e.gridsterOpts={floating:!1,resizable:{enabled:!0,handles:["n","e","s","w","ne","se","sw","nw"],start:function(e,t,n){},resize:function(e,t,n){},stop:function(e,t,n){console.log(n)}},draggable:{enabled:!0,handle:".my-class",start:function(e,t,n){},drag:function(e,t,n){},stop:function(e,t,n){console.log(n)}}},e.customItemMap={sizeX:"item.widgetInfo.sizeX",sizeY:"item.widgetInfo.sizeY",row:"item.widgetInfo.row",col:"item.widgetInfo.col",minSizeY:"item.minSizeY",maxSizeY:"item.maxSizeY"},e.standardItems2=[{attributes:{name:"box1",widgetInfo:{sizeX:6,sizeY:1,row:0,col:0}}},{attributes:{name:"box2",widgetInfo:{sizeX:2,sizeY:2,row:0,col:2}}}],e.executeButton=function(e){console.log(e),i.emit("publish",{topic:"pub/"+d+"/"+e._id,payload:e.payload})},e.saveWidgets=function(){angular.forEach(e.standardItems,function(e,t){console.log(e);var n={widgetInfo:e.widgetInfo};a.updateWidgetById(u,e._id,n).then(function(e){},function(e){})}),e.alertMessage={message:"Successfully Saved!",type:"success"},e.alertShow=!0},e.addThing=function(e){var t=n.open({animation:!1,templateUrl:"templates/thingModal.html",controller:"ThingModalCtrl",resolve:{items:function(){return!1}}});t.result.then(function(e){c(e)},function(){})},e.openSettings=function(e){console.log(e);var t=n.open({animation:!1,templateUrl:"templates/thingModal.html",controller:"ThingModalCtrl",resolve:{items:function(){return e}}});t.result.then(function(e){r(e)},function(){})}}angular.module("RDash").controller("DashboardCtrl",["$scope","$cookieStore","$uibModal","thingService","socket","lodash","widgetService",DashboardCtrl]);
