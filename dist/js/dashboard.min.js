Parse.initialize("pipeeroAppId","pipeeroJavascriptKey"),Parse.serverURL="http://localhost:1337/parse",angular.module("RDash",["ui.bootstrap","ui.router","ngCookies","gridster","ui.bootstrap.modal","btford.socket-io","ngLodash","angular-progress-arc","angular.directives-round-progress","ngStorage","chart.js"]);
...
function LogCtrl(e,t,o,a,n,i,r,l,s){function c(t){o.getLogByThingId(e.thingId).then(function(t){e.logs=t,angular.forEach(t,function(t,o){console.log(t.value),e.data.push(t.value)}),angular.forEach(t,function(t,o){console.log(t.value);var a=new Date(t.createDate);a=a.toString(),a=a.split(" "),e.labels.push(a[4])})},function(e){})}var g="";e.thingId=s.params.thingId,e.data=[],e.labels=[],r.currentUser&&(g=r.currentUser.info.id),c(),e.formatDate=function(e){var t=new Date(e);return t=t.toString()},e.series=["Series A"],e.onClick=function(e,t){console.log(e,t)},e.datasetOverride=[{yAxisID:"y-axis-1"}],e.options={scales:{yAxes:[{id:"y-axis-1",type:"linear",display:!0,position:"right"}]}}}angular.module("RDash").controller("LogCtrl",["$scope","$uibModal","logService","socket","lodash","widgetService","$localStorage","$timeout","$state",LogCtrl]);
